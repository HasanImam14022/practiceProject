...
namespace practiceProject.Repository
{
    public class GenericRepository<Tbl_Entity>: IRepository<Tbl_Entity> where Tbl_Entity : class
    {
        ...
        public void RemovedbyWhereClause(Expression<Func<Tbl_Entity, bool>> wherePredict)
        {
            Tbl_Entity entity = _dbSet.Where(wherePredict).FirstOrDefault();
            Remove(entity);
        }

        public void RemovedRangeByWhereClause(Expression<Func<Tbl_Entity, bool>> wherePredict)
        {
